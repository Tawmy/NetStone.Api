...
namespace NetStone.Cache.Db.Migrations
{
    ...
    [Migration("20260903191659_AddBeastmaster")]
    partial class AddBeastmaster
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetStone.Cache.Db.Models.Character", b =>
                {
                    ...
                    b.Property<string>("AvatarS3")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("avatar_s3");
                    ...
                    b.Property<DateTime?>("CharacterAchievementsUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("character_achievements_updated_at");
                    ...
                    b.Property<string>("PortraitS3")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("portrait_s3");
            ...
            modelBuilder.Entity("NetStone.Cache.Db.Models.CharacterAchievement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime>("TimeAchieved")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("time_achieved");

                    b.HasKey("Id")
                        .HasName("pk_character_achievements");

                    b.HasIndex("CharacterId")
                        .HasDatabaseName("ix_character_achievements_character_id");

                    b.HasIndex("CharacterLodestoneId", "AchievementId")
                        .IsUnique()
                        .HasDatabaseName("ix_character_achievements_character_lodestone_id_achievement_id");

                    b.ToTable("character_achievements", (string)null);
                });
            ...
            modelBuilder.Entity("NetStone.Cache.Db.Models.CharacterAttributes", b =>
                {
                    ...
                    b.Property<int?>("Gathering")
                        .HasColumnType("integer")
                        .HasColumnName("gathering");
            ...
            modelBuilder.Entity("NetStone.Cache.Db.Models.CharacterGear", b =>
                {
                    ...
                    b.Property<string>("Dye1Color")
                        .HasMaxLength(6)
                        .HasColumnType("character(6)")
                        .HasColumnName("dye1color")
                        .IsFixedLength();

                    b.Property<string>("Dye1DatabaseLink")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("dye1database_link");

                    b.Property<string>("Dye1Name")
                        .HasMaxLength(63)
                        .HasColumnType("character varying(63)")
                        .HasColumnName("dye1name");

                    b.Property<string>("Dye2Color")
                        .HasMaxLength(6)
                        .HasColumnType("character(6)")
                        .HasColumnName("dye2color")
                        .IsFixedLength();

                    b.Property<string>("Dye2DatabaseLink")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("dye2database_link");

                    b.Property<string>("Dye2Name")
                        .HasMaxLength(63)
                        .HasColumnType("character varying(63)")
                        .HasColumnName("dye2name");
                    ...
                    b.Property<string>("GlamourIconLink")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("glamour_icon_link");
                    ...
                    b.Property<string>("ItemIconLink")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("item_icon_link");
            ...
            modelBuilder.Entity("NetStone.Cache.Db.Models.CharacterAchievement", b =>
                {
                    b.HasOne("NetStone.Cache.Db.Models.Character", "Character")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_character_achievements_characters_character_id");
